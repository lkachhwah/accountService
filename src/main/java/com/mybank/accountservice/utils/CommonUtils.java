...
public class CommonUtils {
	...
	public BalanceDetailsDto checkCurrencySupportedByAccount(CurrencyType transactionCurrency,
		...
		Optional<BalanceDetailsDto> balanceDetailFoundt = balanceInDifferentCurrency.stream()
				.filter(balance -> balance.getCurrency() == transactionCurrency).findFirst();
	...
	public void checkSufficientBalanceToPerformOperation(TransactionRequestDetails transactionRequestDetails,
		...
		log.info("Balance :{} , transaction :{} ,comparison:{}", balanceDetailsDto.getAmount(),
	...
	public List<TrasnsactionDetailDto> convertListToTransactionDetailDto(
			List<TrasnsactionDetail> trasnsactionDetailsList) {
